...
- [x] Create a new decision tree algorithm based on the BayesianDecisionTree class but using either OptimizedUnivariateEncoding or MultiTreatmentUnivariateEncoding.
...
- [x] Allow the choice of the variable to be configured to any of these algorithms:
