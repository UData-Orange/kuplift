...
def test_get_target_frequencies(opt_ue_with_catvar):
    assert repr(opt_ue_with_catvar.get_target_frequencies("VAR1")) == """
                Part  (0|T0)  (0|T1)  (1|T0)  (1|T1)
0                 []     100       0       0     110
1     ]-inf, 2.0004]       0     100      92       0
2  ]2.0004, 3.00025]      97       0       0      95
3       ]3.00025, 4]       0     107     108       0
4        ]4, 4.9983]     106       0       0      97
5    ]4.9983, 5.991]       1      97      93       0
6    ]5.991, 7.0002]     113       0       0     106
7   ]7.0002, 8.0009]       0     103      91       1
8        ]8.0009, 9]     118       0       0     101
9           ]9, inf]       0      83      81       0"""[1:]
...
5    ]4.9983, 5.991]  0.010638  1.000000  0.989362  0.000000
6    ]5.991, 7.0002]  1.000000  0.000000  0.000000  1.000000
7   ]7.0002, 8.0009]  0.000000  0.990385  1.000000  0.009615
